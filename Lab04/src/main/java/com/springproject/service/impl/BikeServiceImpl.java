...
public class BikeServiceImpl implements BikeService {
    ...
    public BikeDTO createBike(final BikeDTO bikeDTO) {
        ...
        return bikeMapper.toDTO(bikeRepository.createBike(bikeMapper.toEntity(bikeDTO, null)));
    }
    ...
    public BikeDTO updateBike(final BikeDTO bikeDTO) {
        ...
        if(bikeRepository.getBikeById(bikeDTO.getId()).getUser() == null) {
            return bikeMapper.toDTO(bikeRepository.updateBike(bikeMapper.toEntity(bikeDTO, null)));
        } else {
            return bikeMapper.toDTO(bikeRepository.updateBike(bikeMapper.toEntity(bikeDTO, bikeRepository.getBikeById(bikeDTO.getId()).getUser())));
        }
    }
